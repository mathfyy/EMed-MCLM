...
import torch
import pandas as pd
import EMed_MCLM.evaluation_metrics as evaluation_metrics
...
def test_model_EMed_MCLM(CNN, csc, class_token, Ag_param, task_id, label_num):
...
from EMed_MCLM.resnet3D import resnet101, cscBlock
...
if __name__ == '__main__':
    ...
    for task_id in range(num_tasks):
        ...
        for i in range((int(task_id) + 1)):
            ...
            acc, acc_P, acc_N, mauc, mmcc, muf1, muar = test_model_EMed_MCLM(CNN, csc, class_token, Ag_param, i,
                                                                            (i + 1) * num_classes)
